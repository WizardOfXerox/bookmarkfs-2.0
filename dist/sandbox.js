...
/* harmony export */   Extractor: () => (/* reexport safe */ _js_Extractor__WEBPACK_IMPORTED_MODULE_2__.Extractor),
/* harmony export */   UnrarError: () => (/* reexport safe */ _js_Extractor__WEBPACK_IMPORTED_MODULE_2__.UnrarError),
/* harmony export */   createExtractorFromData: () => (/* binding */ createExtractorFromData)
/* harmony export */ });
/* harmony import */ var _js_ExtractorData__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./js/ExtractorData */ "./node_modules/node-unrar-js/esm/js/ExtractorData.js");
/* harmony import */ var _js_unrar_singleton__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./js/unrar.singleton */ "./node_modules/node-unrar-js/esm/js/unrar.singleton.js");
/* harmony import */ var _js_Extractor__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./js/Extractor */ "./node_modules/node-unrar-js/esm/js/Extractor.js");



async function createExtractorFromData({ wasmBinary, data, password = '', }) {
    const unrar = await (0,_js_unrar_singleton__WEBPACK_IMPORTED_MODULE_1__.getUnrar)(wasmBinary && { wasmBinary });
    const extractor = new _js_ExtractorData__WEBPACK_IMPORTED_MODULE_0__.ExtractorData(unrar, data, password);
...
/* harmony export */   UnrarError: () => (/* binding */ UnrarError)
/* harmony export */ });
const ERROR_CODE = {
    0: 'ERAR_SUCCESS',
    10: 'ERAR_END_ARCHIVE',
...
/* harmony export */ });
/* harmony import */ var _ExtractorData_helper__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./ExtractorData.helper */ "./node_modules/node-unrar-js/esm/js/ExtractorData.helper.js");
/* harmony import */ var _Extractor__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./Extractor */ "./node_modules/node-unrar-js/esm/js/Extractor.js");


class ExtractorData extends _Extractor__WEBPACK_IMPORTED_MODULE_1__.Extractor {
    ...
    constructor(unrar, data, password) {
        ...
        this.currentFd = 1;
        const rarFile = {
            file: new _ExtractorData_helper__WEBPACK_IMPORTED_MODULE_0__.DataFile(new Uint8Array(data)),
            fd: this.currentFd++,
        };
    ...
    create(filename) {
        ...
        this.dataFiles[this.getExtractedFileName(filename)] = {
            file: new _ExtractorData_helper__WEBPACK_IMPORTED_MODULE_0__.DataFile(),
            fd: this.currentFd++,
        };
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   getUnrar: () => (/* binding */ getUnrar)
/* harmony export */ });
/* harmony import */ var _unrar__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./unrar */ "./node_modules/node-unrar-js/esm/js/unrar.js");
/* eslint-disable @typescript-eslint/no-explicit-any */

let unrar;
async function getUnrar(options) {
    if (!unrar) {
        unrar = await (0,_unrar__WEBPACK_IMPORTED_MODULE_0__["default"])(options);
    }
    return unrar;
}
...
/*!************************!*\
  ...
  \************************/
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var node_unrar_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! node-unrar-js */ "./node_modules/node-unrar-js/esm/index.esm.js");
...
window.addEventListener("message", async (event) => {
    ...
    try {
        if (data.type === "unrar-list") {
            ...
            const extractor = await (0,node_unrar_js__WEBPACK_IMPORTED_MODULE_0__.createExtractorFromData)({
                data: arrayBuffer,
                wasmFile: "unrar.wasm"
            });
