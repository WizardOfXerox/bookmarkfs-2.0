...
(null == i &&
  ...
  i.register("iMjBX", function (t, n) {
    (e(t.exports, "tr", () => i("k0f7q").tr),
      e(t.exports, "updateHtml", () => i("k0f7q").updateHtml),
      (i("k0f7q").options.disabled = !0));
  }),
  i.register("k0f7q", function (e, t) {
    (Object.defineProperty(e.exports, "__esModule", { value: !0 }), i("jbQPX"));
    var n = i("6B0zc"),
      r = i("aZlj0"),
      o = i("Rue3w");
    ((e.exports.options = { pseudoloc: !1, disabled: !1 }),
      (e.exports.tr = function (t, n, r, i, u) {
        if (((n = n || o.asKey(t)), e.exports.options.disabled))
          return a(t, r, i);
      ...
      return (
        t &&
          ...
          Object.entries(n).forEach(function (n) {
            for (
              var r = n[0], i = n[1].content.split(/\$(\d+)/), o = 1;
              o < i.length;
              o += 2
            ) {
              parseInt(i[o], 10);
      ...
      u = function (e) {
        for (
          ...
          if ("<" === s) {
            if (i)
              throw (
                ((u = new Error("Invalid HTML extra < character: " + e)).name =
                  "InvalidHTMLError"),
                u
              );
            a();
  ...
  i.register("6B0zc", function (e, t) {
    ...
    var n,
      r = (n = i("9tJY1")) && n.__esModule ? n : { default: n };
    function o(e, t) {
      var n =
      ...
      h =
                  ...
                  n = document.createTreeWalker(
                    ...
                    function (e) {
                      return /[^\s]/.test(e.nodeValue)
                        ? s.blacklistedNodeNames.includes(
            ...
            for (n.s(); !(t = n.n()).done;) {
              ...
              if ("childList" === i.type && i.addedNodes.length > 0)
                (u.disconnect(),
                  ...
                  u.observe(document.body, c));
              else if ("characterData" === i.type) {
                var a = i.target.nodeValue,
                  d = s.blacklistedNodeNames.includes(
                    i.target.parentElement.nodeName,
                  );
                l(a) &&
                  !d &&
                  (u.disconnect(),
                  (i.target.nodeValue = (0, r.default)(a, s)),
                  u.observe(document.body, c));
              }
            }
          } catch (e) {
        ...
        }),
        {
          start: function () {
            ...
            ((s.blacklistedNodeNames = i),
              (s.strategy = n),
              f(document.body),
              (u = new MutationObserver(d)).observe(document.body, c));
          },
          stop: function () {
            u && u.disconnect();
          },
  ...
  i.register("9tJY1", function (e, t) {
    ...
    var i = {
      ...
      o = function (e) {
        ...
        return a.startsWith(o.prefix) && a.endsWith(o.postfix)
          ? a
          : o.prefix + a + o.postfix;
      };
    e.exports.default = o;
  }),
  i.register("aZlj0", function (e, t) {
    (Object.defineProperty(e.exports, "__esModule", { value: !0 }),
      (e.exports.ATTR_NAME = "data-e7n"),
      (e.exports.FN_NAME = "tr"));
  }),
  i.register("Rue3w", function (e, t) {
    var n =
  ...
  i.register("aQWOf", function (e, t) {
    ...
    var h = (function (e) {
      ...
      E = { year: T, month: S, day: T },
      M = { year: T, month: S, day: T, weekday: S },
      x = { year: T, month: k, day: T },
      N = { year: T, month: k, day: T, weekday: k },
      _ = { hour: T, minute: T },
      D = { hour: T, minute: T, second: T },
      I = { hour: T, minute: T, second: T, timeZoneName: S },
      A = { hour: T, minute: T, second: T, timeZoneName: k },
      L = { hour: T, minute: T, hourCycle: "h23" },
      C = { hour: T, minute: T, second: T, hourCycle: "h23" },
      ...
      R = { year: T, month: T, day: T, hour: T, minute: T, second: T },
      j = { year: T, month: S, day: T, hour: T, minute: T },
    ...
    var ue = (function () {
            ...
            (n.padTo > 0 && (o.minimumIntegerDigits = n.padTo),
              (this.inf = (function (e, t) {
                ...
                var n = JSON.stringify([e, t]),
                  r = ie[n];
                return (
                  r || ((r = new Intl.NumberFormat(e, t)), (ie[n] = r)),
                  r
                );
              })(e, o)));
          }
        ...
        return (
          (e.prototype.format = function (e) {
            ...
            return Ie(this.floor ? Math.floor(e) : Ve(e, 3), this.padTo);
          }),
          e
        );
      })(),
            ...
            !t &&
              ...
              (this.rtf = (function (e, t) {
                ...
                var r = l(n, K),
                  ...
                  o = oe[i];
                return (
                  o || ((o = new Intl.RelativeTimeFormat(e, t)), (oe[i] = o)),
                  o
                );
              })(e, n)));
        }
      ...
      fe = (function () {
            ...
            return new e(
              o ||
                (i
                  ? "en-US"
                  : ae ||
                    (ae = new Intl.DateTimeFormat().resolvedOptions().locale)),
        ...
        return (
          ...
          (t.numberFormatter = function (e) {
            return (
              void 0 === e && (e = {}),
              new ue(this.intl, e.forceSimple || this.fastNumbers, e)
            );
          }),
          ...
          (t.relFormatter = function (e) {
            return (
              void 0 === e && (e = {}),
              new le(this.intl, this.isEnglish(), e)
            );
          }),
        ...
        return (
          ...
          (t.formatInterval = function (e, t) {
            return (
              void 0 === t && (t = {}),
              this.loc
                .dtFormatter(e.start, i({}, this.opts, t))
    ...
    function At(e, t, n, r, i, o, a) {
      ...
      return (
        a && (s.second = Ae(a)),
        e && (s.weekday = e.length > 3 ? Xe.indexOf(e) + 1 : Ke.indexOf(e) + 1),
        s
      );
    }
    var Lt =
    ...
    function Ct(e) {
      var t,
        ...
        d = e[11],
        h = At(n, o, i, r, a, s, u);
      return ((t = c ? It[c] : l ? 0 : qe(f, d)), [h, new he(t)]);
    }
    var Vt =
    ...
    var un = (function () {
        ...
        return (
          (t.toFormat = function (e, t) {
            ...
            return this.isValid
              ? ct.create(this.loc, n).formatDurationFromString(this, e)
              : "Invalid Duration";
          }),
          ...
          (t.plus = function (t) {
            ...
            for (
              var n = e.fromDurationLike(t), r = {}, i = 0, o = rn;
              i < o.length;
              i++
            ) {
              var a = o[i];
              (_e(n.values, a) || _e(this.values, a)) &&
          ...
          (t.set = function (t) {
            return this.isValid
              ? an(this, { values: i({}, this.values, Ye(t, e.normalizeUnit)) })
              : this;
          }),
          ...
          (t.shiftTo = function () {
            ...
            for (
              var i, o = {}, a = {}, s = this.toObject(), u = 0, c = rn;
              u < c.length;
              u++
            ) {
              var l = c[u];
            ...
            for (var y in a)
              0 !== a[y] && (o[i] += y === i ? a[y] : a[y] / this.matrix[i][y]);
        ...
        return (
          ...
          (t.toLocaleString = function (e, t) {
            return (
              ...
              void 0 === t && (t = {}),
              this.isValid
                ? ct.create(this.s.loc.clone(t), e).formatInterval(this)
                : cn
            );
          }),
          (t.toISO = function (e) {
        ...
        return (
          ...
          (e.weekdays = function (e, t) {
            ...
            var n = void 0 === t ? {} : t,
              ...
              s = n.locObj;
            return (
              (void 0 === s ? null : s) || fe.create(i, a, null)
            ).weekdays(e);
          }),
      ...
      var i = (function (e, t, n) {
          for (
            ...
            n.indexOf(l) >= 0 &&
              ((r = l),
              (o[l] = f(e, t)),
              (i = a.plus(o)) > t ? (o[l]--, (e = a.plus(o))) : (e = i));
          }
          return [e, o, i, r];
        })(e, t, n),
        o = i[0],
      ...
      return (n = Array.prototype).concat.apply(
        ...
        e.map(function (e) {
          return (function (e, t) {
            ...
            var n = In(ct.macroTokenToFormatOpts(e.val), t);
    ...
    function Dn(e, t, n) {
      ...
      var a = (function (e) {
        ...
        v = h[2];
      if (_e(d, "a") && _e(d, "H"))
        throw new p("Can't include meridiem when specifying 24-hour format");
      return {
        input: t,
        tokens: r,
        regex: c,
    ...
    function In(e, t) {
      return e
        ? ct
            .create(t, e)
            .formatDateTimeParts(
              (Nn || (Nn = hr.fromMillis(1555555555555)), Nn),
            )
            .map(function (t) {
              return (function (e, t) {
                var n = e.type,
      ...
      return (
        u < 1
          ...
          : u > Ue(n)
            ? ((t = n + 1), (u = 1))
            : (t = n),
        i({ weekYear: t, weekNumber: u, weekday: s }, Ge(e))
      );
    }
    function jn(e) {
      var t,
    ...
    function Pn(e) {
      var t = Me(e.year),
        n = De(e.month, 1, 12),
        r = De(e.day, 1, Re(e.year, e.month));
      return t
        ? n
          ? !r && Cn("day", e.day)
          : Cn("month", e.month)
    ...
    function er(e, t, n) {
      return (
        ...
        e.isValid
          ? ct
              .create(fe.create("en-US"), { allowZ: n, forceSimple: !0 })
    ...
    function tr(e, t) {
      ...
      return (
        ...
        (r += Ie(e.c.year, n ? 6 : 4)),
        t
          ? ((r += "-"), (r += Ie(e.c.month)), (r += "-"), (r += Ie(e.c.day)))
          : ((r += Ie(e.c.month)), (r += Ie(e.c.day))),
        r
      );
    }
    function nr(e, t, n, r, i, o) {
      ...
      return (
        ...
        (0 === e.c.second && n) ||
          ((a += Ie(e.c.second)),
          (0 === e.c.millisecond && r) ||
            ((a += "."), (a += Ie(e.c.millisecond, 3)))),
        i &&
          (e.isOffsetFixed && 0 === e.offset && !o
            ? (a += "Z")
            : e.o < 0
              ? ((a += "-"),
                (a += Ie(Math.trunc(-e.o / 60))),
                (a += ":"),
                (a += Ie(Math.trunc(-e.o % 60))))
              : ((a += "+"),
                (a += Ie(Math.trunc(e.o / 60))),
    ...
    var hr = (function () {
      function e(e) {
        var t = e.zone || ke.defaultZone,
          n =
            e.invalid ||
            (Number.isNaN(e.ts) ? new lt("invalid input") : null) ||
            (t.isValid ? null : Wn(t));
      ...
      ((e.now = function () {
        ...
        (e.fromJSDate = function (t, n) {
          ...
          return o.isValid
            ? new e({ ts: i, zone: o, loc: fe.fromObject(n) })
            : e.invalid(Wn(o));
        }),
        (e.fromMillis = function (t, n) {
          if ((void 0 === n && (n = {}), Ee(t)))
            return t < -864e13 || t > Yn
              ? e.invalid("Timestamp out of range")
              : new e({
                  ts: t,
                  zone: ye(n.zone, ke.defaultZone),
                  loc: fe.fromObject(n),
                });
          throw new w(
        ...
        (e.fromObject = function (t, n) {
          ...
          var k = v
              ? (function (e) {
                  var t = Me(e.weekYear),
                    n = De(e.weekNumber, 1, Ue(e.weekYear)),
                    r = De(e.weekday, 1, 7);
                  return t
                    ? n
              ...
              : s
                ? (function (e) {
                    var t = Me(e.year),
                      n = De(e.ordinal, 1, Ze(e.year));
                    return t
                      ? !n && Cn("ordinal", e.ordinal)
                      : Cn("year", e.year);
                  })(a)
                : Pn(a),
            O = k || qn(a);
          if (O) return e.invalid(O);
          var E = Qn(v ? jn(a) : s ? zn(a) : a, o, r),
            M = new e({ ts: E[0], zone: r, o: E[1], loc: h });
        ...
        (e.fromISO = function (e, t) {
          void 0 === t && (t = {});
          var n = mt(e, [Ut, Ht], [zt, Yt], [Pt, Wt], [qt, Gt]);
        ...
        (e.fromFormat = function (t, n, r) {
          ...
          var i = r,
            ...
            c = (function (e, t, n) {
              ...
              fe.fromOpts({ locale: a, numberingSystem: u, defaultToEN: !0 }),
              t,
              n,
            ),
            l = c[0],
            ...
            d = c[2],
            h = c[3];
          return h ? e.invalid(h) : Kn(l, f, r, "format " + n, t, d);
        }),
      ...
      return (
        ...
        (t.set = function (e) {
          ...
          r
            ...
            : Oe(n.ordinal)
              ? ((t = i({}, this.toObject(), n)),
                Oe(n.day) && (t.day = Math.min(Re(t.year, t.month), t.day)))
              : (t = zn(i({}, Un(this.c), n)));
        ...
        (t.plus = function (e) {
          return this.isValid
            ? Jn(this, Xn(this, un.fromDurationLike(e)))
            : this;
        }),
        (t.minus = function (e) {
          return this.isValid
            ? Jn(this, Xn(this, un.fromDurationLike(e).negate()))
            : this;
        }),
        ...
        (t.toLocaleString = function (e, t) {
          return (
            ...
            void 0 === t && (t = {}),
            this.isValid
              ? ct.create(this.loc.clone(t), e).formatDateTime(this)
              : Hn
          );
        }),
        (t.toLocaleParts = function (e) {
          return (
            void 0 === e && (e = {}),
            this.isValid
              ? ct.create(this.loc.clone(e), e).formatDateTimeParts(this)
              : []
          );
        }),
        (t.toISO = function (e) {
        ...
        (t.toISOTime = function (e) {
          ...
          return this.isValid
            ? (c ? "T" : "") + nr(this, "extended" === h, o, r, s, f)
            : null;
        }),
        ...
        (e.fromFormatExplain = function (e, t, n) {
          ...
          var r = n,
            ...
            s = void 0 === a ? null : a;
          return Dn(
            fe.fromOpts({ locale: o, numberingSystem: s, defaultToEN: !0 }),
            e,
            t,
          );
        }),
    ...
    function mr(e) {
      ...
      if (e && e.valueOf && Ee(e.valueOf())) return hr.fromJSDate(e);
  ...
  i.register("ecsdh", function (t, n) {
    (e(t.exports, "BORDER_ID", () => a),
      ...
      e(t.exports, "FONT_FAMILY_EMOJIS", () => x),
      e(t.exports, "FONT_FAMILY_SYSTEM_WINDOWS", () => N),
      e(t.exports, "FONT_FAMILY_SYSTEM_MAC", () => _),
      e(t.exports, "FONT_FAMILY_HELVETICA", () => D),
      e(t.exports, "FONT_FAMILY_ARIAL", () => I),
      e(t.exports, "FONT_FAMILY_COMIC_SANS", () => A),
      e(t.exports, "FONT_FAMILY_IMPACT", () => L),
      e(t.exports, "FONT_FAMILY_COURIER", () => C),
      e(t.exports, "FONT_FAMILY_GEORGIA", () => V),
      e(t.exports, "RESIZE_EVENTS", () => F),
      e(t.exports, "TEMPLATE_LAYER_DISPLAY_NAME", () => Z),
      e(t.exports, "TEMPLATE_LAYER_DISPLAY_NAME_HEADER", () => R),
      e(t.exports, "DATE_FORMAT_DATE", () => j),
    ...
    const a = "__border__",
      ...
      D = 'Helvetica, "Segoe UI", Roboto, sans-serif',
      I = "Arial, sans-serif",
      A = '"Comic Sans MS", cursive, sans-serif',
      L = "Impact, Charcoal, sans-serif",
      ...
      U = "NONE",
      z = [
        { title: "Date", format: r.DateTime.DATE_FULL, value: j },
        {
          title: "Date & time",
          format: r.DateTime.DATETIME_FULL,
          value: "DATETIME_FULL",
        },
        {
          title: "ISO",
          format: (e) =>
            e
              .minus({ millisecond: e.millisecond })
              .toISO({ suppressMilliseconds: !0 }),
          value: "ISO",
        },
      ...
      P = (e, t) => {
        if (e) {
          ...
          if (n)
            return "function" == typeof n.format
              ? n.format(e)
              : e.toLocaleString(n.format);
        }
        return "";
      },
      q = "https://blog.bookmarkfs.com/2020/07/20/introducing-bookmarkfs-2/";
  }),
  i.register("jmw9X", function (t, n) {
    (e(t.exports, "CUR_BROWSER_INFO", () => a),
      e(t.exports, "IS_CHROME", () => s),
      e(t.exports, "LOGIN_URL", () => c),
      e(t.exports, "IFRAME_LOGIN_URL", () => l),
      e(t.exports, "IFRAME_SIGNUP_URL", () => f),
      e(t.exports, "PREMIUM_URL", () => d),
      e(t.exports, "SALES_URL", () => h),
      e(t.exports, "ENTERPRISE_URL", () => m),
      e(t.exports, "WEBCOMM_URL", () => y),
      e(t.exports, "DEMO_URL", () => v),
      e(t.exports, "INLINE_DEMO_EDITOR_URL", () => p),
      e(t.exports, "REGISTER_SELF_URL", () => g),
      e(t.exports, "DEFAULT_PLAN_AMOUNT", () => w),
      e(t.exports, "DL_TYPE_IMAGE", () => b),
      e(t.exports, "DL_TYPE_PDF", () => T),
      e(t.exports, "GA_VIA_KEYPRESS", () => S),
      e(t.exports, "GA_VIA_DIALOG", () => k),
      e(t.exports, "GA_VIA_NAV", () => O),
      e(t.exports, "NAMECHANGE_VERSION", () => E));
    const r = "chrome",
      i = "edge",
      o = "edge",
      a = {
        ...
        [i]: {
          ...
          store_url:
            "https://microsoftedge.microsoft.com/addons/detail/bookmarkfs/hfaciehifhdcgoolaejkoncjciicbemc",
          store_reviews_url:
            "https://microsoftedge.microsoft.com/addons/detail/bookmarkfs/hfaciehifhdcgoolaejkoncjciicbemc",
      ...
      y = `${u}/_extcomm`,
      v = `${u}/demos#editor`,
      p = `${u}/demo-editor-inline`,
      g = "";
    if (Boolean(void 0)) {
      if (!g)
        throw new Error("Must have REGISTER_SELF_URL when DEBUG=undefined");
    } else if (g)
      throw new Error("Cannot have a REGISTER_SELF_URL when DEBUG=undefined");
    const w = 1200,
      b = "img",
      T = "pdf",
      S = "keypress",
...
//# sourceMappingURL=welcome_core.js.map
