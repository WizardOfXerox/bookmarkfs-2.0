...
(null == n &&
  ...
  n.register("5Notz", function (a, i) {
    (e(a.exports, "getMaxVersion", () => l),
      e(a.exports, "getEmojiMaxSize", () => _),
      e(a.exports, "default", () => u));
    var o = n("ecsdh"),
      t = n("flY67");
    let r = null;
    const _ = () => {
      if (null === r) {
        const e = c(f(t).tests[f(t).tests.length - 1][1]);
        let a = 200;
        const i = [256, 400, 600];
        for (let f of i) {
          if (!g(e, f)) break;
    ...
    const l = () => {
      ...
      d = () => {
        let e = [];
        return (
          f(t).extraTests.forEach(({ test: f, codes: a }) => {
            g(c(f)) || (e = e.concat(a));
          }),
          new Set(e)
        );
      ...
      g = (f = "🐨", e = null, a = !1) => {
        ...
        ((n.textBaseline = "middle"),
          (n.textAlign = "center"),
          null !== e && (n.font = `${e}px ${o.FONT_FAMILY_EMOJIS}`),
          n.fillText(f, 0, 0));
        const t = 0 !== n.getImageData(0, 0, 1, 1).data[3];
        if (a) {
          const e = "__emojitests";
          ...
          (a ||
            ...
            (n.font = `18px ${o.FONT_FAMILY_EMOJIS}`),
            (n.textAlign = "right"),
            (n.textBaseline = "bottom"));
          const r = n.getImageData(0, 0, 1, 1).data;
          (n.fillText(`${t}[${r[0]},${r[1]},${r[2]},${r[3]}] - ${f}`, 290, 140),
            (i.style.backgroundColor = t ? "#7F7" : "#F77"),
            a.appendChild(i));
        }
        return t;
      };
    var u = (() => {
      ...
      return (
        a > 0 &&
          f(t).groups.forEach(({ group: f, subgroups: o }) => {
            const n = [];
            (o.forEach(({ subgroup: f, emojis: e }) => {
              e.forEach(([e, o, t]) => {
                ("2603" === e && (e = `${e}_fe0f`),
                  t <= a &&
                    !i.has(e) &&
                    n.push({ code: e, name: o, text: c(e), subgroup: f }));
              });
            }),
              n.length && e.push({ group: f, emojis: n }));
          }),
        e
      );
    })();
  }),
  n.register("flY67", function (f, e) {
  ...
  n.register("2OdSy", function (a, i) {
    (e(a.exports, "ZINDEX_FIREWORKS", () => u),
      e(a.exports, "default", () => b));
    var o = n("lSPyV"),
      t = n("1Tjc3"),
      r = n("cAnjR"),
      _ = n("2q4iO"),
    ...
    class b extends _.Component {
      ...
      render() {
        ...
        const { width: f, height: e } = this.state,
          a = Object.assign(
            {
              position: "fixed",
              top: 0,
      ...
      constructor(e) {
        (super(e),
          ...
          (this.canvasRef = f(_).createRef()),
          (this.canRender = (0, g.getMaxVersion)() > 0));
      }
    }
    (0, o.default)(b, "propTypes", { style: f(r).object });
    class h {
      sizeCanvas() {
      ...
      draw(f) {
        ...
        (this.clearIt(),
          (-1 === this.maxNumFireworks ||
            ...
            this.rnd.chance(6) &&
            ((this.numFireworks += 1), this.fireworks.push(new p(this))));
        const e = [];
      ...
      constructor(f, e = -1) {
        ((this.active = !0),
          (this.maxNumFireworks = e),
          (this.numFireworks = 0),
          (this.ctx = f),
          this.sizeCanvas(),
          (this.rnd = new (0, s.Random)()),
          (this.fireworks = []),
          (this.forces = { gravity: new (0, l.TinyVector)(0, 0.2) }),
          (this.emojiSize = 160));
        ((this.emojisCache = new m(this, ["😀", "⭐", "🍬"], this.emojiSize)),
          window.requestAnimationFrame((f) => {
            this.draw(f);
          }));
      }
    ...
    class m {
      ...
      constructor(f, e, a = 128) {
        ((this.rnd = f.rnd),
          (this.emojis = e),
          (this.ctxSize = a),
          (this.ctxs = []));
        const i = (0, d.getIsWindows)();
        this.emojis.forEach((f) => {
          ...
          if (o < 40) {
            const f = -6;
            ((o = (o * (40 - f)) / 40 + f), (o = Math.max(1, o)));
          }
          ((e.fillStyle = `hsl(${this.rnd.int(360)},90%,50%)`),
            (e.textBaseline = "middle"),
            (e.textAlign = "center"),
            (e.font = `${o}px ${c.FONT_FAMILY_EMOJIS}`),
    ...
    class p {
      reset() {
        ((this.color = `hsl(${this.rnd.int(360)},90%,50%)`),
          (this.alive = !0),
          (this.bursting = !1),
          (this.pos = new (0, l.TinyVector)(
            this.rnd.int(0, this.app.w),
            this.app.h + 40,
          )),
          (this.vel = new (0, l.TinyVector)(
            0,
            -this.rnd.real(12, this.app.h / 45),
          )),
          (this.acc = new (0, l.TinyVector)(0, 0)),
        ...
        if (
          ...
          const f = Math.floor(this.app.w / 4),
            e = this.rnd.chance(5)
              ? this.rnd.int(100, f)
              : this.rnd.int(20, 80);
          for (let f = 1; f < e; f++) this.bursts.push(new w(this.pos, this));
        }
      }
      draw() {
    ...
    class w {
      ...
      constructor(f, e) {
        ((this.firework = e),
          (this.app = e.app),
          (this.pos = new (0, l.TinyVector)(f.x, f.y)),
          (this.rnd = e.rnd),
    ...
    const y = (f, e) => f.splice(f.indexOf(e), 1);
  }),
  n.register("dwXyC", function (f, e) {
    /*!
      ...
      return (
        (f.prototype.int = function (f, e) {
          return (
            void 0 === f && (f = 0),
            void 0 === e && (e = 1),
            Math.floor(this.native() * (e - f + 1) + f)
          );
        }),
      ...
      return (
        ...
        (f.prototype.limit = function (f, e) {
          var a = f || null,
            i = e || null;
          return (
            a && this.mag() > a && (this.normalize(), this.mult(a)),
            i && this.mag() < i && (this.normalize(), this.mult(i)),
            this
          );
        }),
        ...
        (f.prototype.angleTo = function (f, e) {
          return (
            void 0 === e && (e = 0),
            Math.atan2(f.y - this.y, f.x - this.x) + e
          );
        }),
        ...
        (f.prototype.lerp = function (f, e) {
          return (
            (this.x += (f.x - this.x) * e || 0),
            (this.y += (f.y - this.y) * e || 0),
            this
          );
        }),
  ...
  n.register("ev0Ha", function (f, a) {
    e(f.exports, "pickDensity", () => i);
    const i = (f, e) => (o() ? e : f),
      o = () => (window.devicePixelRatio || 1) > 1;
  }));
//# sourceMappingURL=welcome_extra.js.map
